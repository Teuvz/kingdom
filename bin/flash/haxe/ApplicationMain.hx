...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("Matt", "kingdom", "com.ukuleledog.games.kingdom.kingdom", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("com.ukuleledog.games.kingdom.Main");
...
import com.ukuleledog.games.kingdom.Main;
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (com.ukuleledog.games.kingdom.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (com.ukuleledog.games.kingdom.Main, Reflect.field (com.ukuleledog.games.kingdom.Main, "main"), []);
...
@:keep class DocumentClass extends com.ukuleledog.games.kingdom.Main { }
